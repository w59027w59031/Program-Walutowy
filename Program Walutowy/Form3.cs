...
namespace Program_Walutowy
{
    public partial class Form3 : Form
    {
        ...
        {
            /// <summary>
            /// Funkcja weryfikuje poprawność danych i dodaje nowego użytkonika do bazy danych
            /// </summary>
            try
            {
                bool jestJuz = false;
                ...
                if (!jestJuz)
                {
                    ...
                    {
                        if (EmailIn.Text.Contains(".") && EmailIn.Text.Contains("@") && EmailIn.Text.Length > 4)
                        {
                            mySqlConnection.Open();
                        ...
                        {
                            MessageBox.Show("Nie porawny email!");
                        }
                    }
                    else
                    {
